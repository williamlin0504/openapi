...
type OcfEventReport struct {
	Type           OcfEventType          `json:"type" bson:"type" `
	State          *OcfEventState        `json:"state" bson:"state" `
	...
	AreaList       []OcfEventArea        `json:"areaList,omitempty" bson:"areaList" `
